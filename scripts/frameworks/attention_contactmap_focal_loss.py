#!/usr/bin/env python3
"""Train attention contact-map model with focal loss and LR scheduling.
...
Usage
-----
    python scripts/frameworks/attention_contactmap_focal_loss.py \
...
def main():
    ...
    run_tag = (f"attn_cm_fl_{dna_short}_{prot_short}_{split_tag}"
