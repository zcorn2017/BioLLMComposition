#!/bin/bash
# One-time environment for hosts without SLURM (e.g. testgpu) and without shared
# /data/conda. Tries CONDA_EXE, Miniconda/Anaconda/Mambaforge in HOME, then /data/conda.
#
# Usage:
#   bash slurm/setup_env_noslurm.sh
#   make setup-env TARGET=testgpu
...
echo "=================================================="
echo "BioLLMComposition: Remote Environment Setup (no SLURM)"
echo "=================================================="
...
_init_conda() {
  ...
  echo "Could not find conda. Install Miniconda3 under HOME or set CONDA_EXE." >&2
  exit 1
}
_init_conda
